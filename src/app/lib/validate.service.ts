...
export class ValidateService {
	// reuse the validator in the backend
	validator = {
		beChecked: {
			userAccount: {
	...
	// adapter
	validateMRegister = this.validator.validateMRegister.bind(this.validator);
	validateRegister = this.validator.validateRegister.bind(this.validator);
	validateLogin = this.validator.validateLogin.bind(this.validator);
	...
	validateUpdateReview = this.validator.validateUpdateReview.bind(this.validator);
	validateChangePassword = this.validator.validateChangePassword.bind(this.validator);
}